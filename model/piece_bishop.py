...
class Bishop(Piece):
    ...
    def update_rep(self):
        if self.color == Color.BLACK:
            self.text_symbol = '♗'
            self.image = r"C:\Users\janth\PycharmProjects\ChessImplementation\Piece Images\b_bishop_png_256px.png"
        else:
            self.text_symbol = '♝'
            self.image = r"C:\Users\janth\PycharmProjects\ChessImplementation\Piece Images\w_bishop_png_256px.png"
